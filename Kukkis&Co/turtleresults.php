...
<body>
  ...
  <div id="contentWrapper">
    ...
    <div id="contentRight">
      ...
      <?php
		$strPitsa = $_POST["pitsa"]; #kylla, ei, eos
		$strTayte = $_POST["tayte"]; #salami, kermavaahto, ei
		$strFiksu = $_POST["fiksu"]; #kylla, ei, eos
		...
		if ($turtle == False) {		
			echo "Unfortunately you can't be a turtle since you don't like pizza.";
		} else if ($turtle == True && $mike == True) {
			echo "You are Michelangelo. Liking whipped cream pizza is probably not your only problem.";
		} else if ($turtle == True && $don == True){
			echo "You are smart so you must be Donatello.";
		} else if ($turtle == True && $raf == True){
			echo "You are not very smart so you have to be Raphael.";
		} else if ($turtle == True && $leo == True){
			echo "You are clearly Leonardo";
		} else {
			echo "Something strange happened. You can be whatever you want!";
		}
